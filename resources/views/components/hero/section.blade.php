...
<section
    ...
    <div class="container max-w-[1140px] mx-auto px-4 md:px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex flex-col justify-center py-[20px] md:py-[50px] text-center md:text-left">

                {{-- headline utama --}}
                <h1 class="text-white font-bold leading-snug text-3xl md:text-4xl lg:text-[42px] mb-5">
                    Tempat Terbaik Belajar Bahasa Inggris Langsung Praktik
                </h1>

                {{-- sub-teks --}}
                <p class="text-white text-[16px] md:text-[20px] mt-[20px] mb-[40px] leading-relaxed">
                ...
                <div class="flex flex-wrap gap-4 justify-center md:justify-start">
                    ...
                    <a href="#daftar"
                       ...
                       class="inline-flex items-center justify-center gap-[5px] bg-warning-7 hover:bg-yellow-500 text-white font-semibold text-[15px] px-6 py-3 rounded-lg transition-all hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto">
                    ...
                    <a href="https://wa.me/6281234567890"
                       ...
                       class="inline-flex items-center justify-center gap-[5px] bg-transparent hover:bg-white/10 text-white font-semibold text-[15px] px-6 py-3 rounded-lg border border-white transition-all hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto">
                        {{-- whatsapp icon --}}
