            ...
            <div class="flex flex-col justify-center py-ev-5 md:py-ev-8 text-center md:text-left">
                ...
                <div class="flex flex-wrap gap-4 justify-center md:justify-start">
                    ...
                    <a href="#daftar"
                       ...
                       class="inline-flex items-center justify-center gap-ev-1 bg-warning-7 hover:bg-yellow-500 text-white font-semibold text-[15px] px-6 py-3 rounded-lg transition-all hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto">
                    ...
                    <a href="https://wa.me/6281234567890"
                       ...
                       class="inline-flex items-center justify-center gap-ev-1 bg-transparent hover:bg-white/10 text-white font-semibold text-[15px] px-6 py-3 rounded-lg border border-white transition-all hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto">
                        {{-- whatsapp icon --}}
