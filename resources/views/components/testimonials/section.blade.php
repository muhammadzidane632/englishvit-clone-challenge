@php
    $testimonials = [
        [
            ...
            'image' => asset('assets/images/sections/Testimonial/person1.png'),
            'video_link' => '#',
        ],
        [
            ...
            'image' => asset('assets/images/sections/Testimonial/person2.png'),
            'video_link' => '#',
        ],
        [
            'name' => 'Nazulal S',
            ...
            'image' => asset('assets/images/sections/Testimonial/person3.png'),
            'video_link' => '#',
        ],
        [
            'name' => 'Fadli Rahman',
            ...
            'image' => asset('assets/images/sections/Testimonial/person4.png'),
            'video_link' => '#',
        ],
        [
            'name' => 'Rina Melati',
            ...
            'image' => asset('assets/images/sections/Testimonial/person5.png'),
            'video_link' => '#',
        ],
    ];
@endphp

<section class="bg-primary-1 pt-ev-5 pb-ev-7" id="testimonials">
