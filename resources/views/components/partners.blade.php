...
<section class="bg-primary-1 pt-4 pb-16 md:pb-28" id="partners">
    <div class="container max-w-ev-container mx-auto px-4 md:px-6">
        <div class="mt-ev-4 pt-ev-4 pb-2 border-t border-gray-100">
            <h3 class="text-center font-bold text-gray-800 text-sm sm:text-base md:text-lg mb-12 md:mb-16">
                ...
                <div class="flex items-center min-w-max animate-[ev-marquee_30s_linear_infinite] pr-12">
                    @foreach($partners as $partner)
                        <div class="flex justify-center items-center mx-4 md:mx-6 shrink-0">
                            <img src="{{ asset('assets/images/sections/partners/' . $partner) }}" alt="Partner" class="h-16 md:h-[72px] w-auto object-contain">
                        </div>
                    @endforeach
                </div>
